                  ...
                  switch( tReset->command )
                  {
                     ...
                     case 'E':
                        ...
                        if( tReset->command == 'E' )
                        {
                           ...
                           {
                              bug( "%s: 'E' reset: can't give object %d to mob %d.", __func__, obj->pIndexData->vnum, mob->pIndexData->vnum );
                              break;
                           }
               ...
               for( tReset = pReset->first_reset; tReset; tReset = tReset->next_reset )
               {
                  ...
                  switch( tReset->command )
                  {
                     ...
                     case 'P':
                        ...
                        if( iNest >= MAX_NEST )
                        {
                           bug( "%s: %s: 'P': Exceeded nesting limit of %d. Room %d.", __func__, filename, MAX_NEST, room->vnum );
                           obj = NULL;
                           break;
                        }
